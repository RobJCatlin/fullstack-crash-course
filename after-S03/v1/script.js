...
async function loadFacts() {
  const res = await fetch(
    "https://xsvarwdmgmaugdannhbs.supabase.co/rest/v1/facts",
    {
      headers: {
        apikey:
        ...
        authorization:
          "Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InhzdmFyd2RtZ21hdWdkYW5uaGJzIiwicm9sZSI6ImFub24iLCJpYXQiOjE2NzYyNDQ5MzUsImV4cCI6MTk5MTgyMDkzNX0.Y2Ilkkp_RkFwT8INUOc1iH-2B7eKLCb-fWxV7xP1HC0",
      },
    }
  );
